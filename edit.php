               ...
               <div class="card">
                   ...
                   <div class="card-body">
                        <form action="edit.php" method="POST">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Awal</label>
                                <input type="date" class="form-control" value="<?= $todo['todo_time']; ?>" name="todo_time" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Akhir</label>
                                <input type="date" class="form-control" value="<?= $todo['dl_time']; ?>" name="dl_time" >
                            </div>
